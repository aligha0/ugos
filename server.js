...
const reports = [
  {
    ...
    problemStatement: 'کاهش ظرفیت تأمین‌کننده از ۱۸۰ به ۹۰ مترمکعب، بتن‌ریزی سقف طبقه ۸ و دو جبهه وابسته را تهدید می‌کند.',
  ...
  },
  {
    ...
    problemStatement: 'تفسیر بند تعدیل قرارداد نما بدون شاخص مرجع مشترک، ریسک هزینه و سابقه قراردادی ایجاد می‌کند.',
